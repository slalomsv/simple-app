...
INSTANCE_ID=`aws ec2 run-instances --image-id ami-156be775 --key-name "$AWS_KEY_NAME" --count 1 --instance-type t2.micro --security-group-ids sg-402a1238 --subnet-id subnet-ea2b1fb2 | jq -r ".Instances[0].InstanceId"`
