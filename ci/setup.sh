...
INSTANCE_ID=`aws ec2 run-instances --image-id ami-156be775 --key-name "$AWS_KEY_NAME" --count 1 --instance-type t2.micro --security-group-ids sg-c2fb4bb9 --subnet-id subnet-ea2b1fb2 | jq -r ".Instances[0].InstanceId"`
